...
func (vm *VM) dispatch(inst core.Instruction, frame *Frame) error {
	...
	case core.OpHostCall:
		...
		result, err := vm.retryCallLike(vm.hostContext(), timeoutProfile.allowsHostCallRetry(opName), timeoutProfile.RetryCount, timeoutProfile.RetryBackoff, timeoutProfile.RetryMaxBackoff, timeoutProfile.RetryMaxElapsed, timeoutProfile.RetryMultiplier, timeoutProfile.RetryJitter, func() (api.CallResult, error) {
	...
	case core.OpHostPoll:
		...
		result, err := vm.retryPollLike(vm.hostContext(), timeoutProfile.RetryCount, timeoutProfile.RetryBackoff, timeoutProfile.RetryMaxBackoff, timeoutProfile.RetryMaxElapsed, timeoutProfile.RetryMultiplier, timeoutProfile.RetryJitter, func() (api.PollResult, error) {

...
func (vm *VM) dispatch(inst core.Instruction, frame *Frame) error {
	...
	case core.OpHostPoll:
		...
		result, err := vm.retryPollLike(vm.hostContext(), timeoutProfile.RetryPollEnabled, timeoutProfile.RetryCount, timeoutProfile.RetryBackoff, timeoutProfile.RetryMaxBackoff, timeoutProfile.RetryMaxElapsed, timeoutProfile.RetryMultiplier, timeoutProfile.RetryJitter, func() (api.PollResult, error) {
